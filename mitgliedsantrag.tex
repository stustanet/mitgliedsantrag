...
{\Large
\ifthenelse{\boolean{onlineform}}
	{\textbf{E-Mail:} \mbox{\underline{\TextField[name=email, bordercolor=white, width=.8\linewidth, borderwidth=0]{ }}}}
	{\textbf{E-Mail:} {\raisebox{-0.15em}{\rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle \enspace \rightangle}}} \\
}
{ \small
Die Angabe der E-Mail Adresse erfolgt auf freiwilliger Basis. Sie dient dazu
bevorstehende Aktionen anzukündigen, welche die Mitgliedschaft betreffen.
Wird keine e-Mail Adresse angegeben, so werden die Ankündigungen an die
StuStaNet-Mail-Adresse verschickt.
}
