...
\rhead{\frakfamily \bfseries \thepage /\pageref*{LastPage}}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}

\fancypagestyle{plain}{
\fancyhf{}
\rfoot{\frakfamily \bfseries \thepage /\pageref*{LastPage}}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{0pt}}
...
\begin{Form}
\begin{center}
  \begin{tabular}{!{\vrule width2pt}>{\small}l|>{\small}r|r!{\vrule width2pt}>{\small}l|r!{\vrule width2pt}}
    \noalign{\hrule height2pt}
    \multicolumn{3}{!{\vrule width2pt}l!{\vrule width2pt}}{\large\textbf{Name:} \fbox{\underline{\TextField[name=name, bordercolor=white, width=.3\linewidth, borderwidth=0]{\ding{231}}}}} & \multicolumn{2}{l!{\vrule width2pt}}{\large\textbf{Vorname:} \fbox{\underline{\TextField[name=vorname, bordercolor=white, width=.3\linewidth, borderwidth=0]{\ding{231}}}}} \\
    \noalign{\hrule height2pt}
    \multicolumn{3}{!{\vrule width2pt}l!{\vrule width2pt}}{\large\textbf{Haus:} \hspace*{\fill} \small{(bitte nachfolgend unten ankreuzen)} \hspace*{\fill}} & \multicolumn{2}{l!{\vrule width2pt}}{\large\textbf{Zimmer:} \hspace*{\fill} \fbox{\underline{\TextField[name=zimmer, bordercolor=white, width=2.4em, maxlen=4, borderwidth=0]{\ding{231}}}}\hspace*{\fill}} \\
    \noalign{\hrule height2pt}
    ...
    \hline
    \multicolumn{2}{!{\vrule width2pt}>{\small}l|}{Grasmeierstr. 7, 9, 11 (ELH), 13 (AKH)} & \fbox{\ChoiceMenu[name=haus, radio, radiosymbol=\ding{53}, bordercolor=black, borderwidth=2, width=1.2em, height=1.2em]{$\!\!$}{3 }}& Willi-Graf-Straße 17 (EWH) & \fbox{\ChoiceMenu[name=haus, radio, radiosymbol=\ding{53}, bordercolor=black, borderwidth=2, width=1.2em, height=1.2em]{$\!\!$}{4 }} \\
    \hline
    \multicolumn{2}{!{\vrule width2pt}>{\small}l|}{Grasmeierstr. 15, 17, 19, 21} & \fbox{\ChoiceMenu[name=haus, radio, radiosymbol=\ding{53}, bordercolor=black, borderwidth=2, width=1.2em, height=1.2em]{$\!\!$}{2 }}& Willi-Graf-Str. 19 & \fbox{\ChoiceMenu[name=haus, radio, radiosymbol=\ding{53}, bordercolor=black, borderwidth=2, width=1.2em, height=1.2em]{$\!\!$}{8 }}\\
    \hline
    \multicolumn{2}{!{\vrule width2pt}>{\small}l|}{Grasmeierstr. 25 (MKH)} & \fbox{\ChoiceMenu[name=haus, radio, radiosymbol=\ding{53}, bordercolor=black, borderwidth=2, width=1.2em, height=1.2em]{$\!\!$}{1 }}& Willi-Graf-Str. 21, 23, 25 & \fbox{\ChoiceMenu[name=haus, radio, radiosymbol=\ding{53}, bordercolor=black, borderwidth=2, width=1.2em, height=1.2em]{$\!\!$}{7 }}\\
    \hline
    \multicolumn{2}{!{\vrule width2pt}>{\small}l|}{Grasmeierstr. 27 (Wohnwürfel / O2 village)} & \fbox{\ChoiceMenu[name=haus, radio, radiosymbol=\ding{53}, bordercolor=black, borderwidth=2, width=1.2em, height=1.2em]{$\!\!$}{16 }}& & \\
    \noalign{\hrule height2pt}
  \end{tabular}
\end{center}
\vfill
